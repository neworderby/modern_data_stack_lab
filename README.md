...
- [Пакет `dbt_expectations`](https://hub.getdbt.com/calogica/dbt_expectations/latest/) — пакет тестов в стиле Great Expectations (v0.10.4): expect-проверки диапазонов, форматов, распределений и других DQ-правил поверх dbt.